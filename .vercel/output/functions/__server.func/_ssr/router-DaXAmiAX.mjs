...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DaXAmiAX.js
var router_DaXAmiAX_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-CQuvEZJq.css";
var APP_NAME = "Omar Tarek Eldeeb";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Omar Tarek Eldeeb — AI Engineer / Machine Learning Engineer in Cairo, Egypt."
			},
			{
				name: "theme-color",
				content: "#09090b"
...
//#endregion
export { getRouter, router_DaXAmiAX_exports as t };
